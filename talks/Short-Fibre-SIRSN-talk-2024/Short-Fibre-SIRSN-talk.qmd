...
format: 
    beamer:
        ...
        nocite: |
            @PlatzmanBartholdi-1989, @PopovVachkovskaia-2002, @DGKendallBardenCarneLe-1999 @Chartier-2017
---
...
\scriptsize
**Abstract: **
{{< include Abstract-paragraph.qmd >}}
...
calculated to add multi-trillion dollar value annually (Chartier 2017).
...
1. Modelling efficient spatial transport systems by an axiomatic approach to 
...
Blanc and collaborators (2022+) have recently made remarkable contributions to our understanding of Plp-SIRSN.
