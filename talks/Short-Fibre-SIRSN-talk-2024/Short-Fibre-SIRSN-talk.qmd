...
or multi-scale stick model for which percolation fails! By monotonicity, this 
applies to case of sticks of speeds \emph{lower} than a specified threshold.
\par}
...
\uncover<6->{Percolation is plausible.}
