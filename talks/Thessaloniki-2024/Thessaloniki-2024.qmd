...
1. It's **tough**. _Either_ massive assumptions (homogeneous mixing) or far too many parameters;
2. It's **really** **tough**. It's hard to get good information about infection times;
3. It's **especially** **tough** early on. You most want to know the answer when there is hardly any information available (I devised a simplified exercise for a Warwick second-year statistics module to show how tough this can be);
...
* Coding in [_julia_](https://julialang.org/) [@BezansonEdelmanKarpinskiShah-2017],  we can derive
[a perfect simulation GIF drawing from conditional distribution of pattern of infections](https://wilfridskendall.github.io/talks/Thessaloniki-2024//animation/animation-IS-256.gif)
(or [MP4](https://wilfridskendall.github.io/talks/Thessaloniki-2024//animation/animation-IS-128.mp4)).

\only<1-5>{
\uncover<5>{\includegraphics[height=1.5in]{image/demo-a.pdf}}
}
\only<6| handout:0>{
...
==========
* You may not need to put up with burn-in issues when doing MCMC. 
Consider the possibility of using perfect simulation!
...
| [_Diamond Princess_](https://commons.wikimedia.org/wiki/File:Diamond_Princess_(ship,_2004)_-_cropped.jpg) | Alpsdake | [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) |
