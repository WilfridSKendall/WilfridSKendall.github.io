...
-------------
\note{
Here, for fun, a detailed look at the six least heavily loaded servers in equilibrium
for an \(M/G/c\) queue. 

Notice how server 25 is carrying a heavier load.
...
Workload distributions of six least heavily loaded servers in an \(M/G/c=25\) queue
...
| Number of customers in \(M/M/c\) queue              | Result of code written by Stephen Connor |              | 
| Run-times for \(M/M/c\) queues                      | Result of code written by Stephen Connor |              | 
