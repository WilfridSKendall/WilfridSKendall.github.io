...
Handout available on the web: either use the `QR-code` and follow links,    
![](image/talk_URL.jpg){width=1in}  
or link directly using this URL:
...
<https://wilfridskendall.github.io/talks/Thessaloniki-2024/index.html>
