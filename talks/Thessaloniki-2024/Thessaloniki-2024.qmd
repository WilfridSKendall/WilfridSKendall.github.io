...
\only<2| handout:0>{\includegraphics[width=3.5in]{image/basic-rw3.png}}
\only<3| handout:0>{\includegraphics[width=3.5in]{image/basic-rw4.png}}
\only<4| handout:0>{\includegraphics[width=3.5in]{image/basic-rw5.png}}
...
\note[item]{That of ourse is the point for small hibernating mammals.}
...
\uncover<3->{\includegraphics[width=1in]{image/LEAF63-empty1.png}} \uncover<4->{\includegraphics[width=1in]{image/LEAF63-empty2.png}} \qquad \uncover<5->{\includegraphics[width=2in]{image/LEAF63-full.png}}
